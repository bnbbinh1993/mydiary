...
import static com.example.mydiary.utils.Bands.PasscodeViewType.TYPE_CHECK_PASSCODE;
import static com.example.mydiary.utils.Bands.PasscodeViewType.TYPE_SET_PASSCODE;


public class Bands extends FrameLayout implements View.OnClickListener {

    private boolean secondInput;
    private String localPasscode = "";
    private Bands.PasscodeViewListener listener;
    ...
    public Bands(@NonNull Context context) {
        this(context, null);
    }

    public Bands(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public Bands setLocalPasscode(String localPasscode) {
    ...
    public Bands.PasscodeViewListener getListener() {
        return listener;
    }

    public Bands setListener(Bands.PasscodeViewListener listener) {
    ...
    public Bands setFirstInputTip(String firstInputTip) {
    ...
    public Bands setSecondInputTip(String secondInputTip) {
    ...
    public Bands setWrongLengthTip(String wrongLengthTip) {
    ...
    public Bands setWrongInputTip(String wrongInputTip) {
    ...
    public Bands setCorrectInputTip(String correctInputTip) {
    ...
    public Bands setPasscodeLength(int passcodeLength) {
    ...
    public Bands setCorrectStatusColor(int correctStatusColor) {
    ...
    public Bands setWrongStatusColor(int wrongStatusColor) {
    ...
    public Bands setNormalStatusColor(int normalStatusColor) {
    ...
    public Bands setNumberTextColor(int numberTextColor) {
        this.numberTextColor = numberTextColor;
        return this;
    }

    public @Bands.PasscodeViewType
    int getPasscodeType() {
        return passcodeType;
    }

    public Bands setPasscodeType(@Bands.PasscodeViewType int passcodeType) {
